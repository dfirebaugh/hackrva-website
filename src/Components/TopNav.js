...
const items = <ul className="navbar-nav topNavRight mr-auto">
...
const TopNav = (props) => {
  ...
  return (
    <div className='topNav'>
      ...
      {getMakeItems(props.makeItems)}
      {/* take in Link items from router */}
        { props.items ? props.items.map( (curr, i) => {
      ...
      {/* {props.makeItems ? props.makeItems.map(i=>i): ''} */}
      </div>
